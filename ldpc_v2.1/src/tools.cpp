...
void* 
chk_alloc(unsigned numberOfElements,		/* Number of elements */
	   unsigned sizeOfElements)		/* Size of each element */
{ 
	void *p;
...
int 
intio_read(FILE *f)   /* File to read from */
{ 
	unsigned char b[4];
	int top;
	int i;
...
void 
intio_write(FILE *f,  /* File to write to */
